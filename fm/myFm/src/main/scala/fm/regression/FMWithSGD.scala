package fm.regression

import fm.optimization.GradientDescentFM
...
object FMWithSGD {
  /**
    ...
    * @param taskCat 0 for Regression, and 1 for Binary Classification
  ...
  def train(input: RDD[LabeledPoint],
    ...
    new FMWithSGD(taskCat, stepSize, numIterations, dim, regParam)
      .setInitStd(initStd)
      .run(input)
  }
